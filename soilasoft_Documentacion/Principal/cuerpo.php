...
<a href="#agenda" data-toggle="tab" aria-expanded="true"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span>&nbsp;Agenda</a>
        
        </li>
    <li class="active" >
        <a href="#paciente" data-toggle="tab" aria-expanded=" " ><span class="glyphicon glyphicon-object-align-left" aria-hidden="true"></span>&nbsp;Paciente</a></li>
        
 
  <li class="dropdown">
    <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="">
     <span class="glyphicon glyphicon-book" aria-hidden="true"></span> &nbsp;Reportes <span class="caret"></span>  
    </a>
    ...
    <ul class="dropdown-menu">
      ...
      <li class="dropdown">
    <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded=""> <span class="glyphicon glyphicon-signal" aria-hidden="true"></span>&nbsp;Gráficas<span class="caret"></span>  
    </a>
