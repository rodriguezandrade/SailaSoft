...
<button type="button"  class="btn btn-primary glyphicon-plus" data-toggle="modal" data-target=".bs-example-modal-lg">Nueva Cita</button>
    ...
    <form method="POST" action="Tabsprincipales/registrarpaciente.php" class="form-horizontal">
  <fieldset>
