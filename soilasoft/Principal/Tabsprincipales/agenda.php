...
<ul class="nav nav-tabs">
  <li class="active">
      <a href="#citas" data-toggle="tab" aria-expanded="true">Lista de Citas</a>
      
      
 </li>
     <li class="dropdown">
    <div class="btn-group">
   <a  class="btn btn-success" href="tabsprincipales/nuevacita.php">Nueva Cita</a>
      </div>
       </li>
      <li class="">
      <a href="#consulta" data-toggle="tab" aria-expanded=" ">Lista de Consultas</a>  
...
?> 
   <div class="btn-group">
   <a  class="btn btn-warning" href="tabsprincipales/nuevaconsulta.php">Nueva Consulta</a>
      </div>
       </li>
</ul>
